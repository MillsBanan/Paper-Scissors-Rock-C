...
messages.o: messages.c messages.h ../../drivers/avr/system.h ../../utils/tinygl.h ../../drivers/navswitch.h ../../fonts/font5x7_1.h ../../utils/font.h ../../utils/pacer.h ../../drivers/button.h
	$(CC) -c $(CFLAGS) $< -o $@
